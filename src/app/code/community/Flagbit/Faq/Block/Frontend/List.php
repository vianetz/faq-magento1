...
class Flagbit_Faq_Block_Frontend_List extends Mage_Core_Block_Template
{
    ...
    public function getFaqCollection($pageSize = null): Flagbit_Faq_Model_Resource_Faq_Collection
    {
        if (! $this->_faqCollection || (intval($pageSize) > 0 && $this->_faqCollection->getSize() !== intval($pageSize))) {
            $this->_faqCollection = Mage::getModel('flagbit_faq/faq')->getCollection()
    ...
    public function getFaqJumplist(): array
    {
