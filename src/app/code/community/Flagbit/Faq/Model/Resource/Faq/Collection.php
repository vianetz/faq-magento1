 ...
 */
class Flagbit_Faq_Model_Resource_Faq_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    protected $_previewFlag;

    protected function _construct()
    {
        $this->_init('flagbit_faq/faq')->setOrder('question', 'ASC');
    }
     ...
     * @return Flagbit_Faq_Model_Resource_Faq_Collection Self
     */
